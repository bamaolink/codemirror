...
class SearchPanel implements Panel {
  ...
  constructor(readonly view: EditorView) {
    ...
    this.dom = elt(
      ...
      [
        this.searchField,
        button("next", () => findNext(view), [phrase(view, "下一个")]),
        button("prev", () => findPrevious(view), [phrase(view, "上一个")]),
        button("select", () => selectMatches(view), [phrase(view, "全部")]),
        elt("label", null, [this.caseField, phrase(view, "区分大小写")]),
        elt("label", null, [this.reField, phrase(view, "正则")]),
        elt("label", null, [this.wordField, phrase(view, "单词匹配")]),
        // ...view.state.readOnly ? [] : [
        //   elt("br"),
        //   this.replaceField,
